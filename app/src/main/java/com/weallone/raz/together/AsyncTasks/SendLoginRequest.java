...
/**
 * Send login request task
 */
public class SendLoginRequest extends AsyncTask<Void, String, String> {
     ...
     * @param activity
     */
    public SendLoginRequest(AsyncResponse delegate, String key, Cookied cookied, String getCookie, String setCookie,
